...
cmd.hear(/^🔹 Главного Администратора$/i, async (message, bot) => {
  ...
  if (message.isChat) {
      if (message.user.settings.adm > 2) {
          ...
          const commands = [
              "Гб [ID] [сумма] (доступ с 5 уровня )",
              "Впред/Спред",
              "Ответ [вкл/выкл] [ID]",
              "-Гб [ID] [сумма] (доступ с 3 уровня )",
...
const commands = [
    ...
    "Удалить [ID поста] - Стереть этот хуевый пост",
